...
type chatRequest struct {
	...
	// Thinking carries the endpoint-level thinking control for non-reasoning
	// models ({"type":"disabled"} or {"type":"enabled","effort":"low"}).
	// Reasoning chat models use ReasoningEffort instead.
